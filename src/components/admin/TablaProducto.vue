<template>
  <div>
    <div class="container">
      <div class="row">
        <div class="col-12">
           <h1 class="mb-4">Panel administrador de productos</h1>
          <button
            type="button"
            class="btn btn-success mb-4 fs-5"
            data-bs-toggle="modal"
            data-bs-target="#Modalagregar"
            @click="cambioDeModalAgregar()"
          >
          ...
          <table class="table">
            <thead>
              <tr class="text-center">
                <th
                  v-for="(item, index) in propsTituloTabla"
                  :key="index"
                  class="bg-warning"
                >
                  {{ item }}
            ...
            <tbody>
              <tr
                ...
                v-for="(product, index) in propsProductos"
                :key="index"
              >
                <td class="border">
                ...
                <td>
                  <div @click="cambioDeModalModificar">
                    <i
                      class="bi bi-pencil-square text-primary fs-3 btn p-0"
                      title="editar"
                      data-bs-toggle="modal"
                      data-bs-target="#Modalagregar"
                      @click="IconoModificarProducto(product)"
                    ></i>
                  </div>
                </td>
                <td>
                  <i
                    class="bi bi-trash text-danger fs-3 btn p-0"
                    title="eliminar"
                    @click="EmitirProductoEliminar(product.id,product.nombre)"
                  ></i>
                </td>
              </tr>
            </tbody>
            ...
            <form @submit.prevent="validarAgregar(btnModal)">
              <div class="mb-2">
                ...
                <p
                  ...
                  v-if="enviado && !$v.producto.nombre.required"
                >
                  {{ campoVacio }}
                </p>
                <p
                  class="text-danger text-center"
                  v-if="enviado && !$v.producto.nombre.minLength"
                >
              ...
              <div class="mb-2">
                ...
                <p
                  class="text-danger text-center"
                  v-if="enviado && !$v.producto.precio.required"
                >
                  {{ campoVacio }}
                </p>
              </div>
              ...
              <div class="mb-2">
                <label for="descripcionProducto" class="form-label pt-2"
                  >Descripción</label
                >
                <p
                  class="text-success d-inline"
                ...
                <p
                  class="text-danger text-center"
                  v-if="enviado && !$v.producto.descripcion.required"
                >
                  {{ campoVacio }}
                </p>
                <p
                  class="text-danger text-center"
                  v-if="enviado && !$v.producto.descripcion.minLength"
                >
              ...
              <div class="mb-2">
                ...
                <p
                  class="text-success d-inline"
                  v-if="$v.producto.imagen.minLength && $v.producto.imagen.required"
                >
                  <i class="bi bi-check-circle-fill fs-5 ms-2"></i>
                </p>
                <input
                ...
                <p
                  class="text-danger text-center"
                  v-if="enviado && !$v.producto.imagen.required"
                >
                  {{ campoVacio }}
                </p>
                <p
                  class="text-danger text-center"
                  v-if="enviado && !$v.producto.imagen.minLength"
                >
